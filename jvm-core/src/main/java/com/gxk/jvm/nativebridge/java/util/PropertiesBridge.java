...
public abstract class PropertiesBridge {
  ...
  public static void registerNative0() {
    ...
    // mock
    MetaSpace.registerMethod("java/util/Properties_<init>_()V", frame -> {
      frame.popRef();
    });
    // mock
    MetaSpace.registerMethod("java/util/Properties_getProperty_(Ljava/lang/String;)Ljava/lang/String;", frame -> {
